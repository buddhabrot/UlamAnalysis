...
I believe interesting findings will emerge by using cluster analysis to define, extract clusters of factors in the Ulam spiral, and generate polynomials that capture a "cluster" completely, clusters which can be repeated to form the full pattern.  
